...
<div class="container">
		<header class="codrops-header">
			...
			<nav class="codrops-demos">
				...
				<a href="?opc=3" style="font-size: 25px; color: black;">Departamentos</a>
				...
				function Mostrar()
				{
					...
					while ($this->row=mysqli_fetch_array($this->query)) {
						...
						echo "
								...
								<div class='caption'>
								<h4><span class='fa fa-home'></span><a href='?opc=description&id=".$this->row['id_departamento']."&tabla=departamento'> ".$this->row['titulo']."</a></h4>

...
<div class="container">
		<header class="codrops-header">
			...
			<nav class="codrops-demos">
				...
				<a  href="?opc=1" style="font-size: 25px; color: black;">Casas</a>
				...
				function Mostrar()
				{
					...
					while ($this->row=mysqli_fetch_array($this->query)) {
						...
						echo "
								...
								<div class='caption'>
								<h4><span class='fa fa-home'></span><a href='?opc=description&id=".$this->row['id_casa']."&tabla=casa'> ".$this->row['titulo']."</a></h4>
								<p><span class='fa fa-taxi'></span> ".$this->row['direccion']."</p>
								<strong><span class='fa fa-mobile-phone'></span>  ".$this->row['telefono']."</strong><br>
